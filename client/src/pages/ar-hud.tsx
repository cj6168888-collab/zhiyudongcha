  ...
  return (
    ...
    >
      ...
      <footer className="flex items-center justify-between px-3 py-2 border-t border-green-500/30">
        <Button variant="outline" onClick={prevMessage} data-testid="ar-prev"><ChevronLeft className="w-4 h-4" />
          <span className="text-xs">上一条</span></Button>
        ...
        <Button variant="outline" onClick={nextMessage} data-testid="ar-next"><span className="text-xs">下一条</span>

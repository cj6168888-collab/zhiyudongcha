  ...
  return (
    ...
    >
      ...
      <div className="absolute top-4 right-4 z-50 flex gap-3">
        <Button variant="outline" size="sm" onClick={handleResetClick} data-testid="button-reset">[重置]</Button>
        <Button variant="outline" size="sm" onClick={handleSkip} data-testid="button-skip">[跳过]</Button>
      </div>
            ...
            >
              <div className="text-center mb-6">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                  确认以后小星将回归母体，<br/>
                  <span className="text-red-300">你所有的资料和小星的想法将全部消失，不可恢复！</span>
                </p>
              </div>

              <div className="flex gap-3">
                <Button variant="outline" onClick={handleCancelReset} data-testid="button-cancel-reset">取消</Button>
                <motion.button
      ...
      {sceneIndex > 0 && (
        <Button variant="outline" onClick={prevScene} data-testid="button-prev-scene">←</Button>
      )}

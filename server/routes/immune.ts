...
const logger = createServiceLogger('Immune');
...
router.post('/scan', async (req: Request, res: Response) => {
  try {
    ...
    logger.info({ deviceId, scanType }, '开始体检');
...
router.get('/health/:deviceId', async (req: Request, res: Response) => {
  try {
    ...
    logger.error({ err: error }, '获取健康报告失败');
...
router.get('/threats/:deviceId', async (req: Request, res: Response) => {
  try {
    ...
    logger.error({ err: error }, '获取威胁列表失败');
...
router.post('/remediate', async (req: Request, res: Response) => {
  try {
    ...
    logger.info({ actionType: request.actionType, targetApp: request.targetApp }, '执行净化');
...
router.post('/report-apps', async (req: Request, res: Response) => {
  try {
    ...
    logger.info({ deviceId, appsCount: apps.length }, '收到设备应用上报');

...
const logger = createServiceLogger('Oracle');
...
export function registerOracleRoutes(app: Express): void {
  ...
  logger.info("[Oracle] 预言家协议路由已注册 /api/oracle/*");
}

      ...
      <div className="container mx-auto p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold">项目模板库</h1>
        ...
        <Tabs value={selectedCategory} onValueChange={setSelectedCategory} className="space-y-4">
          <TabsList className="bg-slate-800/50 border border-slate-700/50">
            <TabsTrigger value="ALL" className="data-[state=active]:bg-amber-500/20 data-[state=active]:text-amber-400" data-testid="tab-all">
              全部
            </TabsTrigger>
            ...
            {selectedTemplate && (
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <label className="text-sm text-slate-400">项目名称</label>
                  <Input

    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 text-white p-6">
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        >
          ...
          <p className="text-slate-400">Desktop Fairy - 小智的跨设备存在</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <Card className="bg-slate-800/50 border-slate-700 col-span-1">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm text-slate-400">小智状态</span>
                <Badge 
              ...
              <div className="space-y-2">
                <span className="text-sm text-slate-400">小智模式</span>
        ...
        <Card className="bg-slate-800/50 border-slate-700">
          <CardHeader>
            <CardTitle className="text-lg">小智姿态预览</CardTitle>
            <CardDescription className="text-slate-400">
              在下方实时预览小智的不同状态和动画
            </CardDescription>
          </CardHeader>
              ...
              {!isActive && !isDeparting && !isArriving && (
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center text-slate-500">
                    ...
                    <p>小智正在别的设备上</p>
                    <p className="text-sm">点击上方"召唤小智到本机"按钮</p>
                  </div>
                </div>
              )}
          ...
          <Card className="bg-slate-800/50 border-slate-700">
            ...
            <CardContent>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
                ...
                <div>
                  <span className="text-slate-400">小智状态</span>

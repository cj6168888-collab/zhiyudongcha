...
router.get('/reminders', async (req: Request, res: Response) => {
  try {
    ...
    console.error('[SocialStrategy API] 获取联络提醒失败:', error);
...
router.get('/report', async (req: Request, res: Response) => {
  try {
    ...
    console.error('[SocialStrategy API] 生成策略报告失败:', error);
...
router.get('/contact/:hash/profile', async (req: Request, res: Response) => {
  try {
    ...
    console.error('[SocialStrategy API] 获取联系人资料失败:', error);
...
router.get('/contact/:hash/optimal-time', async (req: Request, res: Response) => {
  try {
    ...
    console.error('[SocialStrategy API] 获取最佳联络时间失败:', error);
...
router.get('/contact/:hash/maintenance', async (req: Request, res: Response) => {
  try {
    ...
    console.error('[SocialStrategy API] 获取关系维护建议失败:', error);

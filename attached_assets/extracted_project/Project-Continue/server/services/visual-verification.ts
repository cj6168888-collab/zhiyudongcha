  ...
  async verifyWithRetry(
    ...
    while (attempt < retryStrategy.maxAttempts) {
      ...
      try {
        ...
        console.log(`[VisualVerification] Action failed: ${err}`);
      }
      ...
      // 退避
      console.log(`[VisualVerification] Retrying in ${backoffMs}ms (attempt ${attempt}/${retryStrategy.maxAttempts})`);
